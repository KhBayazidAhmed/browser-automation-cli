...
<CardGrid stagger>
	<Card title="Interactive Studio Wizard" icon="laptop">
		Launch `bflow` (or `bun cli`) to access the guided terminal wizard. Run flows, record new sessions, execute scrapers, inspect output files, or drop into a live REPL with intuitive arrow keys.
	</Card>
	<Card title="Live In-Browser Recorder & HUD" icon="star">
		Record interactions directly in Chrome with a compact, keyboard-friendly floating HUD. Grouped step/capture menus, an interactive target picker, and a live drawer turn interactions into clean JSON workflows.
	</Card>
